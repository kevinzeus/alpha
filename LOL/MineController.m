...
- (void)viewDidLoad {
    ...
    // 创建数据源
    _dataArray = @[@"我看过的内容", @"浪费的内存", @"更多内容", @"关于我们", @"版本信息"];
    [self initTableView];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 1) {
        ...
        cell.detailTextLabel.text = [NSString stringWithFormat:@"灰常灰常多",[self filePath]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        ...
        NSString *str = @"http://www.dabaoku.com/dabaoku/uploads/allimg/131212/092532I92-2.jpg";
...
- (void)clearCachSuccess {
    ...
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"提示" message:@"大概..好像..可能..清理干净了" preferredStyle:UIAlertControllerStyleAlert];
